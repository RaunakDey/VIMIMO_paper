...
CV = 1/sqrt(NE(i));
annotation(hf, 'textbox', dim{i}, 'String',  strcat('CV = ','  ',num2str(CV,2), '; ',' N_E =   ',num2str(NE(i)) )  ,'Position', ha(i).Position + [0.2 0 0 0],'EdgeColor','none', 'FontSize',20,'verticalalignment', 'top','FitBoxToText','on') ;
