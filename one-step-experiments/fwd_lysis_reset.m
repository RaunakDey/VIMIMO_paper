...
tvec = 0:0.01:15.75;
[time_opt,y_series_opt] = one_step_simulate_lysis_reset(tvec,y0,theta_optimized,NE_optimal,dilution_factor);


total_virus = y_series_opt(end,:);
