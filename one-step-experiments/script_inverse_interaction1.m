...
%data.xdata{1} = time_free_phages./60;
%data.ydata{1} = free_phages;

%moi = [0.0969       0.0494       0.0689];
%V0_replicates = [4850000     4850000     4850000];
%S0_replicates = [   5.0052e+07   9.8178e+07   7.0392e+07];

%theta_optimized = [ 0.245     2.18e-08         1.85        94.21          135];
%theta_osu = [0.245 1.88e-8 prior_values.latent_period/60  prior_values.burst_size theta_optimized(5)];
...
% initial values for the model states
    ...
    {'beta', beta_opt, 0, 700, beta_osu, 100}
...
save("./result_replicates/18:2_18_12_"+string(seed));
