...
infectious_ratio = 0.0172;

qpcr_host = 1e3*[4.30E+02	2.66E+02	4.71E+02;
2.90E+03	2.27E+03	2.71E+03];


qpcr_virus = 1*1e3*[1.50E+04	1.50E+04	1.37E+04;
...
theta_optimized = [ 0.245     2.18e-08         2.85        94.21          135];

NE_optimal = round(theta_optimized(5));
clear y0
B0 = mean(qpcr_host(1,:));
V0 = mean(qpcr_virus(1,:));
tvec = 0:0.1:15.8;
...
for i = 1:length(Dc_array)
    [time_seivd_temp, y_series_seivd] = one_step_simulate_noninfectious_seivd(tvec,B0,V0,theta_optimized,NE_optimal,Dc_array(i),infectious_ratio);
