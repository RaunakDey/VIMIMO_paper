function [time,y,time_abs,pre_dil] = one_step_simulate_new_features(t,y0,theta,NE,dilution_factor)
...
solved2 = ode45(@(t,y) one_step_eqn_after_dilution_new_features(t,y,theta,NE), time',y_ini);
y=solved2.y;
time=solved2.x;
