...
%2024
beta_onestep = [   126.55        1.901       63.884        36.55       75.092       87.229       387.27       324.15];
tau_onestep = [   1.8781       1.9068       2.0352       1.8012       1.4589       1.3709       2.179       2.0193];
phi_onestep = [ 1.776e-08   5.6449e-08   1.2386e-07    3.506e-08   1.2251e-07   8.5023e-08   5.694e-08   4.4429e-08];



beta_onestep_error = [    36.508      0.12939       48.102       45.319       30.193       42.213       145        71.87];
tau_onestep_error = [   0.038254      0.26513      0.17063      0.27281      0.11118     0.075967     0.16     0.078438];
phi_onestep_error = [ 5.2604e-09   1.1261e-08   2.7217e-08   1.2592e-08   1.3211e-08    9.791e-09    1.7522e-08    7.4481e-09];
...
boxes_onestep = [   148.01           10       171.79       77.868        138.8       108.48          167       187.61];
boxes_onestep_error = [ 22.555     0.043257       84.682       64.002       72.778       25.955       14.606       61.193];
