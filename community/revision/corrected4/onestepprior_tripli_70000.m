...
data.ydata(:,1) = reshape(host1,84,1);
data.ydata(:,2) = reshape(host2,84,1);
data.ydata(:,3) = reshape(host3,84,1);
data.ydata(:,4) = reshape(host4,84,1);
data.ydata(:,5) = reshape(host5,84,1);

data.ydata(:,6) = reshape(virus1,84,1);
data.ydata(:,7) = reshape(virus2,84,1);
data.ydata(:,8) = reshape(virus3,84,1);
data.ydata(:,9) = reshape(virus4,84,1);
data.ydata(:,10) = reshape(virus5,84,1);

data.xdata  = repmat(data.xdata,3,1);
...
save('from_os_prior_tripli_70000.mat')
