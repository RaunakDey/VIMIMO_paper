...
%theta_optimized = search_minimum_cba(theta_initial,theta_sd,data,model,pars2,mcmcpars2,0.2,50,1);

error_cba(theta_optimized,pars2,data,model,mcmcpars2)
