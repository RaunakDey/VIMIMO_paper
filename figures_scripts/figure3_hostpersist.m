...
load('./../one-step-experiments/data_2024/CBA18-3_4_2024.mat');
name = string(labels.phage)+'_'+string(labels.host);
load('parameters.mat','pars');
...
load('./../one-step-experiments/data_2024/CBA18-3_18_2024.mat');
...
load('./../one-step-experiments/data_2024/CBA38-1_38.mat');
...
load('./../one-step-experiments/data_2024/HP1_H100_2024.mat');
...
load('./../one-step-experiments/data_2024/HP1_13-15_2024.mat');
...
load('./../one-step-experiments/data_2024/HS6_H100_2024.mat');
...
load('./../one-step-experiments/data_2024/HS6_13-15_2024.mat');
y0(1) = mean(qprc_host(1,:));
y0(2:NE_optimal+2) = 0;
y0(NE_optimal+3) = mean(qprc_virus(1,:));
...
plot(time_opt,host_den,'LineWidth',7,'Color',[0.8,0.8,0.8]);
set(gca, 'YScale', 'log');
...
load('./../one-step-experiments/data_2024/CBA18-2_18_2024.mat');
name = string(labels.phage)+'_'+string(labels.host);
time_free_phages = time_free_phages/60;
load('parameters.mat','pars');
...
plot(time_opt(1:2:end),host_den(1:2:end),'LineWidth',7,'Color',[0.8,0.8,0.8]);
set(gca, 'YScale', 'log');
set(gca,'FontName','Times','FontSize',24);
ylim([1e-3 1e7])
yticks([1e-3 1e-1 1e1 1e3 1e5 1e7]);
