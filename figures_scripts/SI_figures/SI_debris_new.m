...
pars_sample.Dc  = 10^(5 + 2*rand);   % between 1e6 and 1e7
pars_sample.Dc2 = 10^(5 + 2*rand);
pars_sample.Dc3 = 10^(5 + 2*rand);
pars_sample.Dc4 = 10^(5 + 2*rand);
pars_sample.Dc5 = 10^(5 + 2*rand);
