...
subplot(2,4,4)
errorbar((1:2)-gap, [mean(hp1_h100_beta),mean(hp1_1315_beta)],[std(hp1_h100_beta),std(hp1_1315_beta)],Marker="o", MarkerEdgeColor=[0.5,0.5,0.5],MarkerFaceColor=[0.5,0.5,0.5],Color=[0.5,0.5,0.5],MarkerSize=10,LineStyle="none")
hold on;
errorbar((1:2), [mean(hp1_all_beta),mean(hp1_all_beta)],[std(hp1_all_beta),std(hp1_all_beta)],Marker="square",MarkerEdgeColor='k',MarkerFaceColor='w',Color='k',MarkerSize=10,LineStyle='none')
...
subplot(2,4,8)
errorbar((1:2)-gap, [mean(hs6_h100_beta),mean(hs6_1315_beta)],[std(hs6_h100_beta),std(hs6_1315_beta)],Marker="o",MarkerEdgeColor=[0.5,0.5,0.5],MarkerFaceColor=[0.5,0.5,0.5],Color=[0.5,0.5,0.5],MarkerSize=10,LineStyle="none")
hold on;
errorbar((1:2), [mean(hs6_all_beta),mean(hs6_all_beta)],[std(hs6_all_beta),std(hs6_all_beta)],Marker="square",MarkerEdgeColor='k',MarkerFaceColor='w',Color='k',MarkerSize=10,LineStyle='none')
